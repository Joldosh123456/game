...
function showUsers() {
  $list.innerHTML = ""; // для не дублирования списка в браузер
  list = getData("listUsers");
  list.sort(compare)
  if (list.length > 10){
  ...
  list.forEach(function (elem) {
    // user = {}; // для не наследования предыдущими объектами в браузере
...
//   let json = jstoJSON(data);
//   localStorage.setItem("update", json);
// }

// function jstoJSON(data) {
